...
interface Props {
  ...
  onNavigateToRetiring: () => void
}

export default function Dashboard({ onNavigateToEmployee, onNavigateToRetiring }: Props) {
...
<div className="dash-card highlight" onClick={onNavigateToEmployee} style={{ cursor: 'pointer' }}>
...
<div className="dash-card" onClick={onNavigateToRetiring} style={{ cursor: 'pointer' }}>
           <div className="dash-card-icon">
             <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
